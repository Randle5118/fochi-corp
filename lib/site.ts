...
export const site = {
  ...
  tagline: "納得は、一緒に探すもの。",
  description:
    "株式会社Fochiは、月極駐車場の満空管理サービス monthly-parking の開発・運営と、プロダクト・業務づくりのご相談を行っています。",
  ...
  // COPY.md 3-5 / 4-2 の導線はこの値を参照する（app.fochi.co.jp は存在しない）。
...
export const company = {
  ...
  business: [
    "月極駐車場の満空管理・一次受付サービスの開発・運営",
    "プロダクト・業務づくりのご相談、受託開発",
  ],
} as const;
